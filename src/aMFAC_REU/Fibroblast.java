...
public class Fibroblast {
	...
	private double kgen = 0.075; //area fraction/hr
	private double kdeg = 0.0025; //area fraction/hr		
...
/*		GridValueLayer layer; //for each layer
	...
	public void updateCollagen() {
		...
		int y = pt.getY();
			...
			double dcdt = kgen*depLevel - kdeg*(degLevel*currentCollagen);
			
			System.out.println(depLevel);
			
			collagen.set(currentCollagen + dcdt, x, y);
		}
		catch  (Exception e) {
